...
KEYWORD_INTERESTS: List[tuple[str, str]] = [
    ...
    ("obra", "Museos, teatro, cine"),
    ("expos", "Eventos culturales y ferias"),
    ("exposición", "Eventos culturales y ferias"),
    ("festival", "Eventos culturales y ferias"),
    ("feria", "Eventos culturales y ferias"),
    ("charl", "Eventos culturales y ferias"),
    ("seminar", "Eventos culturales y ferias"),
    ("encuentro", "Eventos culturales y ferias"),
    ("patrimonio", "Historia y cultura"),
    ("histori", "Historia y cultura"),
    ("bibliotec", "Club de lectura"),
    ("literatur", "Club de lectura"),
    ("club de lectura", "Club de lectura"),
    ("poes", "Escritura / lectura creativa"),
    ("escrit", "Escritura / lectura creativa"),
    ("taller", "Cursos online / talleres"),
    ("manual", "Manualidades (tejido, carpintería, cerámica)"),
    ("ceram", "Manualidades (tejido, carpintería, cerámica)"),
    ("fotograf", "Fotografía"),
    ("concierto", "Música (escuchar, cantar, tocar instrumento)"),
    ("orquesta", "Música (escuchar, cantar, tocar instrumento)"),
    ("sinfón", "Música (escuchar, cantar, tocar instrumento)"),
...
FEED_DEFAULT_INTERESTS = {
    ...
    "eventos valparaíso": ["Eventos culturales y ferias"],
}
